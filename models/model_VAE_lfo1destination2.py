...
class VAE_lfo1destination2(nn.Module):
    def __init__(self):
        super(VAE_lfo1destination2, self).__init__()
...
# m = VAE_lfo1destination2().float()
# d = torch.rand(17,1,256,256).float()
# x = m(d)
