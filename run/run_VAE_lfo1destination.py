...
def main():
    ...
    for epoch in range(n_epochs):
        ...
        outfile_epoch = "/home/moshelaufer/PycharmProjects/VAE/data/lfo1destination/loss_arr_mid2_KL2.npy"
        np.save(outfile_epoch, np.asarray(loss_arr_mid))
        outfile_epoch = "/home/moshelaufer/PycharmProjects/VAE/data/lfo1destination/loss_arr_out2_KL2.npy"
        np.save(outfile_epoch, np.asarray(loss_arr_out))

        if epoch <= 2:
            path = "/home/moshelaufer/PycharmProjects/VAE/data/lfo1destination/modelVAE_KL2.pt"
