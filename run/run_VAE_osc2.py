...
def main():
    ...
    for epoch in range(n_epochs):
        ...
        outfile_epoch = "/home/moshelaufer/PycharmProjects/VAE2/data/_osc2/loss_arr_mid2_KL2.npy"
        np.save(outfile_epoch, np.asarray(loss_arr_mid))
        outfile_epoch = "/home/moshelaufer/PycharmProjects/VAE2/data/_osc2/loss_arr_out2_KL2.npy"
