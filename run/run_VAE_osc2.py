...
def main():
    ...
    file = open("/home/moshelaufer/PycharmProjects/VAE/data/_osc2/process_state_VAE_KL.txt", "a")
    ...
    for epoch in range(n_epochs):
        ...
        for batch_num, data in enumerate(data_loader):
            ...
            if batch_num % 100 == 0 and batch_num > 0:
                print(
                    "[Epoch %d/%d] [Batch %d/%d] [Mid loss: %f] [Out loss: %f] VAE_osc2"
        ...
        file.write('\n')
        file.write('loss_mid_tot = %f , loss_out_tot = %f  VAE_osc2\n' % (loss_mid_tot, loss_out_tot))
        ...
        outfile_epoch = "/home/moshelaufer/PycharmProjects/VAE/data/_osc2/loss_arr_mid2_KL2.npy"
        np.save(outfile_epoch, np.asarray(loss_arr_mid))
        outfile_epoch = "/home/moshelaufer/PycharmProjects/VAE/data/_osc2/loss_arr_out2_KL2.npy"
        np.save(outfile_epoch, np.asarray(loss_arr_out))

        if epoch <= 2:
            path = "/home/moshelaufer/PycharmProjects/VAE/data/_osc2/modelVAE_KL2.pt"
